...
<head>
    ...
    <link rel="stylesheet" href="{{ secure_asset('assets/css/LineIcons.3.0.css') }}" />
    <link rel="stylesheet" href="{{ secure_asset('assets/css/tiny-slider.css') }}" />
    <link rel="stylesheet" href="{{ secure_asset('assets/css/glightbox.min.css') }}" />
...
<body>
    ...
    <script src="{{ secure_asset('assets/js/glightbox.min.js') }}"></script>
